...
execute store result score input7 WorkbenchStatus run data get block ~ ~ ~ Items[20].Count
execute store result score input8 WorkbenchStatus run data get block ~ ~ ~ Items[21].Count
execute store result score input9 WorkbenchStatus run data get block ~ ~ ~ Items[22].Count
...
execute store result block ~ ~ ~ Items[20].Count byte 1 run scoreboard players get input7 WorkbenchStatus
execute store result block ~ ~ ~ Items[21].Count byte 1 run scoreboard players get input8 WorkbenchStatus
execute store result block ~ ~ ~ Items[22].Count byte 1 run scoreboard players get input9 WorkbenchStatus
